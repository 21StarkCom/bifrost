...
Confirm the ledger's `sender` names your session. Claude attribution needs your own
cmux surface. If attribution is missing, send a fresh note from that surface or escalate;
`msg resend` copies the missing sender and cannot repair it.
